...
migrate
```
![](image/compile-migrate.jpeg)


- 当前的目录结构
![](image/list-index.jpeg)
...
![](image/ipfsstart.jpeg)

- 重新编译,部署

![](image/compile-reset.jpeg)

# 选择文件,点击提交 ,测试
![](image/test-result.jpeg)

# 不懂联系我weChat: chen1048258
